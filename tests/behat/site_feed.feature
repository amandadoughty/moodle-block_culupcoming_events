@block @cul @block_culupcoming_events @block_culupcoming_events_site_feed @javascript
Feature: CUL Upcoming events block used on the frontpage
  In order to be kept informed
  As a user
  I see a feed of all events on the front page
